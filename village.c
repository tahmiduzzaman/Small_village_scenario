...
float i=0,m=0,n=0,o=0,c=0,b=0;
float p=0.75,q=0.47,r=0.14;
float e=0.90,f=0.91,g=0.98;
int count=0;

int light=1,day=1,xm=900,bird=0;
char ch;
...
//tree3
    ...
    {
        glColor3f(0.0,0.5,0.0);
        draw_circle(370,230,l);
        draw_circle(410,230,l);
    }

    for(l=0; l<=22; l++)
    {
        glColor3f(0.0,0.5,0.0);
        draw_circle(380,270,l);
...
//tree 1
    ...
    if(bird==1)
    {
        ...
        glBegin(GL_POLYGON);
        glVertex2f(150+i-xm,375+b);
        glVertex2f(180+i-xm,375+b);
        glVertex2f(180+i-xm,360+b);

        glEnd();

        glBegin(GL_POLYGON);
        glVertex2f(180+i-xm,385+b);
        glVertex2f(190+i-xm,385+b);
        glVertex2f(180+i-xm,375+b);
        ...
        //bird 3
        glBegin(GL_POLYGON);
        glVertex2f(300+i-xm,285+b);
        glVertex2f(330+i-xm,285+b);
        glVertex2f(330+i-xm,270+b);

        glEnd();

        glBegin(GL_POLYGON);
        glVertex2f(330+i-xm,295+b);
        glVertex2f(340+i-xm,295+b);
        glVertex2f(330+i-xm,285+b);
        ...
        //bird 4
        glBegin(GL_POLYGON);
        glVertex2f(380+i-xm,265+b);
        glVertex2f(410+i-xm,265+b);
        glVertex2f(410+i-xm,250+b);

        glEnd();

        glBegin(GL_POLYGON);
        glVertex2f(410+i-xm,275+b);
        glVertex2f(420+i-xm,275+b);
        glVertex2f(410+i-xm,265+b);
        ...
        glEnd();
         ...
         //bird 5
        glBegin(GL_POLYGON);
        glVertex2f(460+i-xm,265+b);
        glVertex2f(490+i-xm,265+b);
        glVertex2f(490+i-xm,250+b);

        glEnd();

        glBegin(GL_POLYGON);
        glVertex2f(490+i-xm,275+b);
        glVertex2f(500+i-xm,275+b);
        glVertex2f(490+i-xm,265+b);
...
void keyboardFunc( unsigned char key, int x, int y )
{
    ...
    case 'B':
        ...
        b=0.0;
        count=0;
        PlaySound(TEXT("bird1.wav"), NULL, SND_ASYNC);
        break;
...
{
    //int c_menu;
    printf("Created by Rakib and Rashed\n");
    printf("--------------");
    printf("  Simple_Village_scenario  ");
    printf("---------------\n\n");
    ...
    glutCreateWindow("Simple_Village_scenario");
